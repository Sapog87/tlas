            ...
            <div className="w-full text-white text-[25px] flex justify-between items-center max-w-[1300px]">
                ...
                {logged &&
                    <div className="relative inline-block">
                        ...
                        {showMenu && (
                            <div
                                className="absolute right-0 w-40 rounded-md bg-white shadow-lg p-2 z-10">
                                <div
                                    className="text-black text-xl truncate"
                                >
                                    {user.name}
                                </div>
                                <button
                                    className="w-full font-bold text-red-500 hover:bg-gray-100 rounded-md px-2 py-1 text-sm"
                                    onClick={() => {
