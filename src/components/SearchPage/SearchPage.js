...
function SearchPage({
    ...
    useEffect(() => {
        ...
        const filtered = data
            ...
            .filter((t) =>
                carrier.size === 0 || (t.carrier.size !== 0 && t.carrier.isSubsetOf(carrier))
            )
            .filter((t) =>
    ...
    return (
        <div>
            <div className="fixed z-20 w-full min-w-[900px]">
                <Header
                    logged={logged}
                    setLogged={setLogged}
                        ...
                        return (
                            <div className="relative flex justify-center py-10">
                                <div
                                    ...
                                    <div className="text-xl text-center">
                                        Попробуйте изменить конечную или начальную точку отправления, а может быть и
                                        дату
                                    </div>
                                </div>
                            </div>
